...
<section class="inner-page_banner section-padding" style="background-image: url( https://atn.linkbuilderpros.com/wp-content/uploads/2024/04/image-6.png)">
    <div class="container">
                                ...
                                <div class="radius-8 contbg-wrap">
                                    <div class="single-latest-blog-content">
                                        ...
                                        <div class="date-category">
                                            ...
                                            if (!empty($category)) : ?>
                                                <a href="<?php echo get_category_link($category[0]->term_id); ?>" class="post-category-name fs-14 <?php echo esc_attr($category[0]->slug); ?> text-uppercase fw-bold text-white text-decoration-none bg-success-main">
